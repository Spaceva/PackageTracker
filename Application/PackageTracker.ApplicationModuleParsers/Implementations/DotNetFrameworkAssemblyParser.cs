...
internal class DotNetFrameworkAssemblyParser(IPackagesRepository packagesRepository, ILogger<DotNetAssemblyParser> logger) : ApplicationModuleParser(packagesRepository, logger)
{
