...
internal class TelegramNotifierBot(string token, IMediator mediator, IServiceProvider serviceProvider) : TelegramChatBot(mediator, serviceProvider)
{
    ...
    protected override Task HandleCallbackQueryUpdateAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;

    protected override Task HandleChannelChatCreatedAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;

    protected override Task HandleChannelPostUpdateAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;

    protected override Task HandleChatJoinRequestUpdateAsync(TelegramIncomingMessage telegramIncomingMessage) => Task.CompletedTask;

    protected override Task HandleChatMemberUpdateAsync(TelegramIncomingMessage telegramIncomingMessage) => Task.CompletedTask;

    protected override Task HandleChosenInlineResultUpdateAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;

    protected override Task HandleEditedChannelPostAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;

    protected override Task HandleEditedMessageAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;
    ...
    protected override Task HandleInlineQueryUpdateAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;
    ...
    protected override Task HandleMyChatMemberUpdateAsync(TelegramIncomingMessage telegramIncomingMessage) => Task.CompletedTask;

    protected override Task HandlePollAnswerUpdateAsync(TelegramIncomingMessage telegramIncomingMessage) => Task.CompletedTask;

    protected override Task HandlePollUpdateAsync(TelegramIncomingMessage telegramIncomingMessage) => Task.CompletedTask;

    protected override Task HandlePreCheckoutQueryUpdateAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;
    ...
    protected override Task HandleShippingQueryUpdateAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;

    protected override Task HandleSupergroupChatCreatedAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;

    protected override Task HandleUnknownUpdateAsync(TelegramIncomingMessage incomingMessage) => Task.CompletedTask;
