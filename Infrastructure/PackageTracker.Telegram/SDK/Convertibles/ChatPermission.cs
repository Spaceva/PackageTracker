namespace PackageTracker.Telegram.SDK.Convertibles;

internal class ChatPermission : IConvertible, IComparable<ChatPermission>, IEqualityComparer<ChatPermission>, IEquatable<ChatPermission>, IComparer<ChatPermission>
{
